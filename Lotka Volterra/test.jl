...
function plot_phase_portrait(true_trajectory, learned_trajectory)
    fig = Figure()
...
function plot_vector_field(params, alpha, beta, delta, gamma)
    ...
    save("vector_field_comparison.png", fig)
    return fig
end

function plot_loss_curve(loss_history)
    fig = Figure()
...
plot_phase_portrait(true_trajectory, learned_trajectory)
